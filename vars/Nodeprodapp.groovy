...
withEnv(["AWS_ACCESS_KEY_ID=${env.AWS_ACCESS_KEY_ID}", "AWS_SECRET_ACCESS_KEY=${env.AWS_SECRET_ACCESS_KEY}", "AWS_DEFAULT_REGION=${env.AWS_DEFAULT_REGION}"]) {
          ...
          sh 'scp -i "/var/lib/jenkins/dev-server.pem" -r /var/lib/jenkins/workspace/replication-loadbalance-nodejs/docker-compose.yml ec2-user@ec2-35-176-254-143.eu-west-2.compute.amazonaws.com:/home/ec2-user'
          sh 'scp -i "/var/lib/jenkins/dev-server.pem" -r /var/lib/jenkins/workspace/replication-loadbalance-nodejs/docker-compose1.yml ec2-user@ec2-35-176-254-143.eu-west-2.compute.amazonaws.com:/home/ec2-user'
          sh 'ssh -o StrictHostKeyChecking=no -i /var/lib/jenkins/dev-server.pem ec2-user@ec2-35-176-254-143.eu-west-2.compute.amazonaws.com sudo bash /home/ec2-user/deploy_test.sh "${tag}"'
